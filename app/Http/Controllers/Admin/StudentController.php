...
use App\Services\Moodle\BaseService;
...
class StudentController extends Controller
{
    ...
    public function store(Request $request, StudentService $student_service, StudentEnrollService $moodle_student_enroll_service)
    {
        ...
        try {
            ...
            $student->moodle_username = generate_moodle_username($request->first_name, $request->last_name);
    ...
    public function login(Request $request, BaseService $baseService)
    {
        $baseService->Login_To_Moodle();
    }
}
