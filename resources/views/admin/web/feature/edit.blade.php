            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <a href="{{ route($route.'.edit',$row) }}" class="btn btn-info"><i class="fas fa-sync-alt"></i> {{ __('btn_refresh') }}</a>
                    </div>
                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control texteditor" name="description" id="description" required>{{ old('description',$row->description) }}</textarea>
