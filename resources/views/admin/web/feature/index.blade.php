...
<div class="main-body">
    <div class="page-wrapper">
        ...
        {{-- <div class="row">
            @can($access.'-create')
                <form class="needs-validation p-0" novalidate action="{{ route($route.'.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                                  ...
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Include Show modal -->
                                            @can($access.'-edit')
                                            <a href="{{ route($route.'.edit' , $row) }}" class="btn btn-icon btn-primary btn-sm" >
