...
<body>
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light headerpos-fixed header-lightblue">
        ...
        <div class="collapse navbar-collapse">
            ...
            <span>{{ Auth::user()->first_name }} {{ Auth::user()->last_name }} - {{ Auth::user()->student_id }}</span>
                                            ...
                                            @if ($key < 10)
                                                ...
                                                <li class="notification">
                                                    @if ($notification->data['type'] == 'assignment')
                                                        ...
                                                        @else
                                                            <a class="media"
                                                                href="{{ route($notification_link, $notification->data['id']) }}">
                                                    @endif
                                                    <div class="media-body">
                                                        ...
                                                        <p><i class="fas fa-arrow-circle-right"></i> {{ $notification_type }}
                                                        </p>
                                                    </div>
                                                    </a>
                                                </li>
                    ...
                    <li>
                        <div class="dropdown drp-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-notification">
                                <div class="pro-head">
                                    <img src="{{ asset('uploads/student/' . Auth::user()->photo) }}" class="img-radius"
                                        alt="User Profile"
                                ...
                                <ul class="pro-body">
                                    <li><a href="{{ route('student.profile.index') }}" class="dropdown-item"><i
