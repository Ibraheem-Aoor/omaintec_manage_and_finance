                    ...
                    <div class="row">
                        @foreach ($features as $key => $feature)
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class="services-box07 @if ($key == 1) active @endif h-370">
                                    <div class="sr-contner">
                                        ...
                                        <div class="text">
                                            <h5>{{ $feature->title }}</h5>
                                            <p>{!! str_limit(strip_tags($feature->description), 120, ' ...') !!}</p>
                                            <a href="{{ route('feature.single', ['slug' => $feature->slug]) }}" class="readmore">{{ __('btn_read_more') }} <i class="fal fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
