                                ...
                                <nav id="mobile-menu">
                                    <ul>
                                        ...
                                        <li class="{{ Request::is('course*') ? 'current' : '' }}"><a
                                                href="{{ route('course') }}">{{ trans_choice('module_program', 2) }}</a>
                                        </li>
                                        ...
                                        {{-- <li class=""><a
                                                href="{{ route('news') }}">{{ trans_choice('module_download', 2) }}</a>
                                        </li> --}}
                                        <li class=""><a
                                                href="{{ route('student.login') }}">{{ __('navbar_trainee_login') }}</a>
                                        </li>
                                        <li class=""><a
                                                href="{{ route('login') }}">{{ __('navbar_prof_login') }}</a></li>
                                        {{-- <li class="#"><a href="#">{{ __('navbar_how_to_apply') }}</a></li> --}}
                                ...
                                <ul>
                                    @if (Route::has('student.login'))
                                        <li><a href="{{ route('student.login') }}"
                                                target="_blank">{{ __('field_student') }} {{ __('field_login') }}</a>
                                        </li>
                                    @endif
                                    @if (Route::has('login'))
